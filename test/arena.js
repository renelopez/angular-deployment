   ...
   beforeEach(function(){
    ...
    describe('Scoring',function(){
       ...
       it('should calculate the combat score for an animal',inject(function(Arena){
        ...
        it('should calculate the terrain influence of a terrain and a animal',inject(function(Arena){
    ...
    describe('Scoring',function(){
        ...
        it('should determine if winner if the matchup is not equal',inject(function(Arena){
            var outcome=Arena.determineWinner(this.alligator,this.rhino,this.swamp);
            outcome.should.equal('player');
        }));

        it('should determine if draw if the matchup is equal',inject(function(Arena){
